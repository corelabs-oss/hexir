...
// // /// call interface.
// // Operation::operand_range GenericCallOp::getArgOperands() { return
// // getInputs(); }

// // /// Get the argument operands to the called function as a mutable range, this
// // is
...
// // /// Infer the output shape of the MulOp, this is required by the shape
// // inference
// // /// interface.
